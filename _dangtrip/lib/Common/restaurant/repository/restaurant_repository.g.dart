...
class _RestaurantRepository implements RestaurantRepository {
  ...
  @override
  Future<CursorPagintion<RestaurantModel>> paginate() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CursorPagintion<RestaurantModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CursorPagintion<RestaurantModel>.fromJson(
      _result.data!,
